...
class featureExtractor:
	def __init__(self,HarrisExtractor):
		self.harris_Points = HarrisExtractor.harris_Points
		self.gradientMatrix = HarrisExtractor.gradientMatrix
		self.bin = HarrisExtractor.bin
